...
/**
 * Patient sign-in screen, built to sit exactly inside the viewport below
 * the Navbar (no Footer, no page scroll on desktop — see AuthLayout).
 * Mirrors the approved reference design 1:1: hero/mascot panel on the
 * left, credential form on the right. Auth wiring is out of scope here
 * (see PatientRegisterPage sibling) — submission is simulated so the full
 * flow and states can be reviewed end-to-end.
 */
export default function PatientLoginPage() {
  ...
  if (!identifier.trim() || !password.trim()) {
    setError(
      "Enter your ABDM ID or email, and your password, to continue."
    );
    return;
  }
      ...
      <div className="relative flex w-full shrink-0 flex-col overflow-hidden bg-gradient-to-br from-mx-green-soft via-mx-bg to-mx-blue-soft px-6 py-6 sm:px-10 sm:py-8 lg:h-full lg:w-1/2 lg:px-12 lg:py-8 xl:px-16">
        ...
        >
          <h2 className="font-display text-2xl font-extrabold leading-[1.15] text-mx-ink sm:text-3xl">
            Making Your <br />
            <span className="text-[var(--mx-green-strong)]">Health Journey</span> <br />
            Simpler.
          </h2>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate className="mt-6 flex flex-col gap-4">
            <div className="rounded-mx-md transition-shadow duration-150 focus-within:shadow-[0_0_0_4px_var(--mx-green-soft)]">
              <Input
                label="ABDM ID or Email Address"
                type="text"
                name="identifier"
                autoComplete="username"
                placeholder="ABDM ID or Email Address"
            ...
            <button
              ...
              onClick={() =>
                showToast({
                  ...
                  description: "This will be wired up alongside patient authentication.",
                })
              }
